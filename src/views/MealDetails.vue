<template>
    <div class="max-w-[800px] mx-auto p-8">
     ...
     <div class="grid grid-cols-1 sm:grid-cols-3 text-lg py-2">
       <div>
         <strong class="font-bold">{{ $t('message.category') }}:</strong> {{ meal.strCategory }}
       </div>
       <div>
         <strong class="font-bold">{{ $t('message.area') }}:</strong> {{ meal.strArea }}
       </div>
       <div>
         <strong class="font-bold">{{ $t('message.tags') }}:</strong> {{ meal.strTags }}
       </div>
     </div>
